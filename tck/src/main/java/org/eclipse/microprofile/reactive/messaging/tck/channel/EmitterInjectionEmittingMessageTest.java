...
public class EmitterInjectionEmittingMessageTest extends TckBase {
    ...
    public void testWithMessages() {
        ...
        assertThat(myBeanEmittingMessages.emitter().isCancelled()).isFalse();
        assertThat(myBeanEmittingMessages.emitter().hasRequests()).isTrue();
    }
