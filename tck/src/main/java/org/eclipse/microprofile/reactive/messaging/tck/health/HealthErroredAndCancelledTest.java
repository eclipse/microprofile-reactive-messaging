...
/**
 * Combination of failed and cancelled channels scenario:
 * <ul>
 ...
 * <li>8. Send onError signal to one of the channels and cancel to another</li>
...
public class HealthErroredAndCancelledTest extends HealthBase {
    ...
    public void testOneErroredChannelLiveness() {
        ...
        channelRegister.get(CHANNEL_CONNECTOR_IN).cancel();
        getLiveness()
            .assertResponseCodeDown()
            .assertMessagingStatusDown();
    }
