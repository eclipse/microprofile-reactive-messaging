...
/**
 * Cancelled connector channel scenario:
 * <ul>
...
public class HealthCancelledConnectorOutChannelTest extends HealthBase {
    ...
    public void testOneCancelledChannelLiveness() {
        channelRegister.get(CHANNEL_CONNECTOR_OUT).cancel();
        getLiveness()
            .assertResponseCodeDown()
            .assertMessagingStatusDown();
    }
