 ...
 * </pre>
 * <p>
 * You can use an injected emitter to send either payloads or {@link org.eclipse.microprofile.reactive.messaging.Message
 * Messages}.
 * <p>
 * The name of the channel (given in the {@link Channel Channel annotation}) indicates which channel is fed. It must
 * match the name used in a method using {@link org.eclipse.microprofile.reactive.messaging.Incoming @Incoming} or an
...
public interface Emitter<T> {
     ...
     *
     * @param msg
     *            the <em>thing</em> to send, must not be {@code null}
     ...
     *
     * @param <M>
     *            the <em>Message</em> type
     * @param msg
     *            the <em>Message</em> to send, must not be {@code null}
     * @throws IllegalStateException
     *             if the channel has been cancelled or terminated or if an overflow strategy of
     *             {@link OnOverflow.Strategy#THROW_EXCEPTION THROW_EXCEPTION} or {@link OnOverflow.Strategy#BUFFER
     *             BUFFER} is configured and the emitter overflows.
     ...
     *         connects to, return {@code false} otherwise.
     */
    boolean hasRequests();
